      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-[#151920]/80">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-white">SRMUCANVAS 2026 SHOWREEL</span>
          </div>
          <button 
            onClick={onClose}
            className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
        ...
        <div className="relative aspect-video w-full bg-black overflow-hidden flex items-center justify-center group">
          <img 
            ...
            alt="SRMUCANVAS Showreel Visuals"
          ...
          <div className="absolute flex flex-col items-center gap-4 z-10">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-[#9A9DA7] tracking-wider uppercase">4K HDR • Performance Marketing, SEO, AI & Campaigns</p>
            </div>
          </div>
